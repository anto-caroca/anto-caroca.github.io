        ...
        ScrollReveal().reveal('.accordion', { delay: 1000 })
        
        /* contacto */ 
        ScrollReveal().reveal('.contacto', { delay: 500 })
        ScrollReveal().reveal('#linkedin', { delay: 1000 })
        ScrollReveal().reveal('#github', { delay: 1200 })
        ScrollReveal().reveal('#phone', { delay: 1500 })
        ScrollReveal().reveal('#mail', { delay: 1800 })
        ScrollReveal().reveal('#address', { delay: 2000 })
